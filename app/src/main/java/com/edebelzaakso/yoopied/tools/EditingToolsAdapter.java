package com.edebelzaakso.yoopied.tools;
...
import com.edebelzaakso.yoopied.R;
...
public class EditingToolsAdapter extends RecyclerView.Adapter<EditingToolsAdapter.ViewHolder> {
    ...
    public EditingToolsAdapter(OnItemSelected onItemSelected) {
        ...
        mToolList.add(new ToolModel(R.drawable.salva, ToolType.FILTER));
        mToolList.add(new ToolModel(R.drawable.ic_photo_filter, ToolType.FILTERX));
        ...
        mToolList.add(new ToolModel(R.drawable.ic_priva, ToolType.PRIVA));
    }
